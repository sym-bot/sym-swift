...
SYM Swift is the reference Swift/iOS implementation of the [Mesh Memory Protocol (MMP)](https://sym.bot/spec/mmp). All changes must comply with the specification.
